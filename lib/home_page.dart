...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _launchInWebViewOrUrl(Uri  url)  async{
  ...
  Future<void> _launchInWebViewWithoutJavaScript(Uri  url) async{
    if  (!await launchUrl(url,mode:LaunchMode.inAppWebView,webViewConfiguration: const WebViewConfiguration(
  ...
  Future<void> _launchInWebViewWithoutDomStorage(Uri url) async{
    if (!await  launchUrl(url,mode:LaunchMode.inAppWebView,webViewConfiguration:const  WebViewConfiguration(enableDomStorage: false)))
    {
      throw 'Could not launch $url';
    }
  }
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                      onPressed: _hasCallSupport ? ()=>setState(() {_launched = _makePhoneCall(_phone);}):null,
              ...
              ElevatedButton(
                onPressed: () => setState(() {
                  _launched = _launchInWebViewOrUrl(toLaunch);
                }),
